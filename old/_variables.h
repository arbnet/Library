...
namespace v {
	...
	template <typename dTYPE>
	bool isMain=isMatch_t<dTYPE,LOGIC,LETTER,RANGE,BYTE,INT_S,INT_W,INT_M,INT_L,INT_T,INT_B,FLOAT,DOUBLE,POINTER,DATETIME,STRING>::v;
}
...
public:
	...
	template <typename dTYPE>
	explicit operator dTYPE(){//*static_cast<dTYPE*>
